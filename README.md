...
a Mac for SparkMeter development.

To setup run the following command :
```
curl -s https://raw.githubusercontent.com/EarthSpark/setupmac/master/start.sh | /bin/bash
```
...
what get's installed at [here](https://raw.githubusercontent.com/EarthSpark/setupmac/master/roles/setup/vars/main.yml). If you want to change the list of applications, clone
